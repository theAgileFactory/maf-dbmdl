...
INSERT INTO `kpi_value_definition` (`last_update`, `name`, `render_type`, `render_pattern`, `computation_js_code`, `is_trend_displayed`) 
	VALUES (NOW(), 'kpi.release_burndown.main.name', 'PATTERN', ':d md', NULL, '1');
INSERT INTO `kpi_value_definition` (`last_update`, `name`, `render_type`, `render_pattern`, `computation_js_code`, `is_trend_displayed`) 
	VALUES (NOW(), 'kpi.release_burndown.additional1.name', 'PATTERN', ':d md', NULL, '1');
INSERT INTO `kpi_value_definition` (`last_update`, `name`, `render_type`, `render_pattern`, `computation_js_code`, `is_trend_displayed`) 
	VALUES (NOW(), 'kpi.release_burndown.additional2.name', 'PATTERN', ':d md', NULL, '0');
