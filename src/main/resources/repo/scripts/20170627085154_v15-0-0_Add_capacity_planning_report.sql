...
VALUES (0, Now(), 3, (select id from reporting_authorization where expression = 'reporting.capacity_report'), 'reporting.capacity_report.name', 'reporting.capacity_report.description', 1, 1, 0, 'capacity_report', 'en,fr,de', 'PDF,EXCEL,CSV');
